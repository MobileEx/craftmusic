...
import ExClusiveArt from './ExclusiveArt';
import CustomIcon from './CustomIcon';
import { COLORS, METRICS, STYLES } from '../global';
import Button from './Button';

class LicenseArtExclusive extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      text: '',
  ...
  async createPDF(htmlStr) {
    ...
    const options = {
      html: htmlStr,
      fileName: 'EXCLUSIVE ART LICENSE',
      directory: 'Documents',
    };
  ...
  render() {
    ...
    if (craftData !== '' || userProfileData !== '') {
      const htmlStr =
        userProfileData !== ''
          ? ExClusiveArt.ExclusiveArtTxt.replace('[BUYER]', userProfileData.username)
          : ExClusiveArt.ExclusiveArtTxt;
      const htmlStr1 =
        craftData !== ''
      ...
      htmlStrFinal = ExClusiveArt.ExclusiveArtTxt;
      var htmlWithRoyalty = ExClusiveArt.ExclusiveArtTxt.replace(/xxx/g, this.state.royalty);
          ...
          <View style={styles.wrapper}>
            <View style={styles.background}>
              ...
              <View style={styles.titleWrapper}>
                <Text style={styles.title}>Exclusive Art License</Text>
              </View>
            ...
            <CustomIcon name="edit2" size={METRICS.fontSizeBig} style={styles.icons} />
              ...
              <KeyboardAwareScrollView style={{ height: 600 * METRICS.ratioY }}>
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  This exclusive copyright license agreement (the Agreement), created on and
                  effective as of{' '}
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  The Licensor hereby warrants that Licensor owns the copyright to the artistic work
                  to be licensed (the Art) and/or has the necessary permissions to license the Art.
                  The Licensee wants to obtain, and the Licensor has agreed to grant, a license
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  a. The Licensor hereby grants to Licensee a worldwide, exclusive, nontransferable
                  license to exercise the following rights in the Art, in all media (including, but
                  not limited to, electronic, video, print, physical or virtual products, and any
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  iii. to distribute copies of, display, or use in any advertising the Art,
                  including as incorporated in Collective Works or Derivative Works.
                </Text>
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  The Licensee may not sublicense the Art, without the prior written consent of the
                  Licensor. Any use that is inconsistent with the limited license provided in this
                  agreement will be a violation of the Licensor's copyright and subject to copyright
                  law. Should Licensee use the Art in a Derivative Work or Collective Work that
                  creates a work of joint authorship with any third party, said third party must
                  agree in writing to be bound by this agreement as an additional Licensee.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  1 above without the prior written consent of the Licensor. Licensor may not make a
                  non-transformative use of the Art except for monetary value at fair market rates.
                  Licensee may not allow third parties to use, copy, or download the Art without
                  paying at least industry standard market rate.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  iv. Limitations on Transfer. The license hereby granted is exclusive, not
                  transferable, and applies only to the Art that is the subject of this transaction.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  and nothing in this agreement constitutes an assignment of the Licensor's rights
                  in the Art. The Licensor retains ownership of the copyright in the Art, and all
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  Fee). The License Issue Fee is not an advance toward royalties that may become due
                  during any calendar quarter and the Licensee shall not deduct the amount of the
                  License Issue Fee from any royalties that may become due from the sale or use of
                  the Art, a Collective Work, or a Derivative Work.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  of Gross Sales of the price collected from the end users of any Collective Work,
                  and/or any Derivative Work incorporating any part of the Art sold by the Licensee
                  or any of its subsidiaries, divisions, agents, owners, or affiliates, even if sold
                  by third party distributors. If the Collective Work or Derivative Work is
                  published, displayed, used in monetized videos or other works, or otherwise used
                  in conjunction with advertising revenue, or revenue received from patronage,
                  Licensor shall instead receive{' '}
                  <Text style={styles.inputs}>
                    {craftData === '' ? this.state.royalty : craftData.craft_items[0].royalty}%
                  </Text>{' '}
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  Gross Revenue means any monetary renumeration received by Licensee arising from or
                  related to the Art, Derivative Work, or Collective Work other than a sale of said
                  work.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  If the Licensee sells, licenses, or otherwise allows the use of the Art, the
                  Collective Work, or any Derivative Work to any party affiliated with the Licensee,
                  or in any way related to or under common control with the Licensee, at a price
                  less than the regular price charged to other parties, the royalties will be
                  computed on the basis of the regular price charged to other parties. No deduction
                  from the royalties owed will be allowed for uncollectible accounts, or for taxes,
                  fees, assessments, advertising, or other expenses of any kind that maybe incurred
                  or paid by the Licensee, except as specifically enumerated in the definition of
                  Gross Sales. The Licensee shall report and pay royalties quarterly. The royalty
                  report deadline is 30 days after the end of each calendar quarter.
                </Text>
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  series, or related work owned or used by the Licensor. The previous
                  notwithstanding, nothing in this agreement gives the Licensee any interest in the
                  Art other than the right to use them in accordance with this agreement.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  might be acquired in the Art by the Licensee because of its use of the Art shall
                  inure to the sole benefit of the Licensor. This subsection does not entitle the
                  Licensor to any of the revenues from the Licensee™s permitted uses under this
                  agreement, except for the fees described in section 5 above.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  validity of this agreement or the grants provided under it. The Licensee may
                  register the Art or any Collective Works or Derivative Works created from the Art
                  under any content identification systems for the purpose of protecting the content
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  a. Termination Procedures. Unless otherwise agreed by the Parties in writing,
                  signed by each Party, Licensee™s right to exclusivity and right to use, copy,
                  distribute, or sell non-transformative uses will end on the 10-year anniversary of
                  this Agreement. Licensee will thereafter be granted a non-exclusive right to
                  continue exploitation of any Derivative Works or Collective Works created before
                  the 10-year anniversary of this agreement but may not, without Licensor™s express
                  permission, create any new Derivative Works or Collective Works using the Art. The
                  agreement will terminate immediately, without notice, if:
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  i. the Art enters the public domain;
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  iv. the Licensee uses the Art in a manner not expressly permitted by this
                  agreement;
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  v. no Collective Work, Derivative Work, or reproduction of Art is published within
                  one year of the effective date of this agreement, unless extended by written
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  vii. Licensor earns no royalty on the Art, pursuant to this agreement for a period
                  of at least 6 months following the 1-year anniversary of this agreement.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  b. The Agreement will terminate with 15 days prior notice being sent to the
                  Licensee, in the event that any payment due under this agreement is not paid when
                  due. The licensee shall have the right to cure said breach within the 15-day
                  ...
                  Licensee shall have 10 days to cure after the accountant sends notice to both
                  parties of any of the above. If the default remains uncured 10 days after the
                  accountant™s notice is received by licensee, this Agreement shall be automatically
                  thereby terminated.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  c. Effect of Termination. All rights granted by this agreement, including the
                  ...
                  reproduction, publishing, display or distributing of the Collective Work or
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  d. Licensee agrees that a breach or threatened breach of this Agreement by
                  Licensee gives rise to irreparable injury to Licensor, which may not be adequately
                  ...
                  violation by the Licensee of any provision of this Agreement. Licensee™s
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  government of said jurisdiction as the arbitral institution. If any country
...
LicenseArtExclusive.propTypes = {
  onClose: PropTypes.func,
  status: PropTypes.bool,
  onCloseRequest: PropTypes.func,
};

LicenseArtExclusive.defaultProps = {
  onClose: () => {},
  status: false,
  onCloseRequest: () => {},
};

export default LicenseArtExclusive;
