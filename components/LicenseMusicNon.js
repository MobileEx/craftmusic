...
import NonExclusive from './NonExclusiveMusic';
import CustomIcon from './CustomIcon';
import { COLORS, METRICS, STYLES } from '../global';
import Button from './Button';

class LicenseMusicNon extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      text: '',
  ...
  async createPDF(htmlStr) {
    ...
    const options = {
      html: htmlStr,
      fileName: 'NON-EXCLUSIVE MUSIC LICENSE',
      directory: 'Documents',
    };
  ...
  render() {
    ...
    if (craftData != '' || userProfileData != '') {
      const htmlStr =
        userProfileData != ''
          ? NonExclusive.NonExclusiveMusicTxt.replace('[BUYER]', userProfileData.username)
          : NonExclusive.NonExclusiveMusicTxt;
      const htmlStr1 =
        craftData != ''
      ...
      htmlStrFinal = NonExclusive.NonExclusiveMusicTxt;
          ...
          <View style={styles.wrapper}>
            <View style={styles.background}>
              ...
              <View style={styles.titleWrapper}>
                <Text style={styles.title}>Non-Exclusive Music License</Text>
              </View>
              {/* <TouchableOpacity style={styles.edit}>
            <CustomIcon name="edit2" size={METRICS.fontSizeBig} style={styles.icons} />
    </TouchableOpacity> */}
              <TouchableOpacity
                onPress={() => (htmlStrFinal != '' ? this.createPDF(htmlWithAdTimes) : null)}
              ...
              <KeyboardAwareScrollView style={{ height: 600 * METRICS.ratioY }}>
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  The Licensor hereby warrants that Licensor owns the copyright to the musical work
                  to be licensed (the “Music”) and/or has the necessary permissions to license the
                  Music. The Licensee wants to obtain, and the Licensor has agreed to grant, a
                  license authorizing the use of the Music in the preparation of one or more
                  Collective Works or Derivative Works for one or more of the purposes defined
                  below.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  to exercise the following rights in the Music, in all media (including electronic,
                  video, audio, and any other technology now known or that may be developed in the
                  future):
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  i. to incorporate, include and/or use the Music in the preparation of one or more
                  Collective Works. “Collective Works” means any work, including music or video
                  compilations, in which the entire unmodified Music is assembled with other
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  any work based on the Music, or on the Music and other preexisting works,
                  including a new piece of instrumental music created by the Licensee, a song made
                  by recording written lyrics over the Music, and/or an audiovisual work created
                  with the Music. Permission is granted to Licensee to modify the arrangement,
                  length, tempo, or pitch of the Music in preparation of the Derivative Work for
                  public release. A work constituting a Collective Work is not considered a
                  Derivative Work under this agreement; and
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  iii. to distribute copies of, display, perform publicly, or use in any advertising
                  the Music, including as incorporated in Collective Works or Derivative Works.
                </Text>
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  perform, or use in any advertising the Music only under the terms of this
                  agreement. The Licensee may not sublicense the Music or transfer this license,
                  without the prior written consent of the Licensor. Any use that is inconsistent
                  with the limited license provided in this agreement will be a violation of the
                  Licensor's copyright and subject to copyright law. Should Licensee use the Music
                  in a Derivative Work or Collective Work that creates a work of joint authorship
                  with any third party, said third party must either also purchase a license from
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  the Music obtained from the Licensor in any way not specifically granted in
                  section 1 above without the prior written consent of the Licensor.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  iii. Right of Review. The Licensor may review any Collective Work or Derivative
                  Work before publication and if the Music exceeds 50% of its total content the
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  not exclusive, and applies only to the Music being licensed in this transaction.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  the Licensor's rights in the Music. The Licensor retains ownership of the
                  copyright in the Music, and all rights not expressly granted in this agreement.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>4. CREDIT AND SAMPLES.</Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  a. Credit. Acknowledgement of the original creator of the Music is automatically
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  Music to allow the Licensor to confirm compliance with the grant of permission
                  given under this agreement. Derivative works are automatically tracked through the
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  of any advertising material that will accompany distribution of the Music, or any
                  Collective Work or Derivative Work.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  d. Copy of Critical Work. If the Music will be reproduced in a Collective Work or
                  Derivative Work as a subject of criticism, a copy of the text addressing the Music
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  for any non-transformative use of any Collective Work within an advertisement.
                  This Advertising Fee allows the Licensee use of said Collective Work{' '}
                  <Text style={styles.inputs}>
                    {craftData == ''
                      ? this.state.adtimes
                      : craftData.craft_items[0].number_of_ads_allowed}
                  ...
                  Fee must be paid for any further non-transformative use of any Collective Work in
                  an advertisement.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  any Derivative Work incorporating any part of the Music sold by the Licensee or
                  any of its subsidiaries, divisions, agents, owners, or affiliates, even if sold by
                  third party distributors. If the Collective Work or Derivative Work is performed,
                  licensed for streaming, or otherwise used in conjunction with advertising revenue,
                  or revenue received from patronage, Licensor shall instead receive{' '}
                  <Text style={styles.inputs}>
                    {craftData == '' ? this.state.royalty : craftData.craft_items[0].royalty}%
                  </Text>{' '}
                  of the gross revenue received by any person so exploiting the Collective work or
                  the Derivative Work (“Gross Revenue”). Any non-transformative use of the Music
                  shall have a{' '}
                  <Text style={styles.inputs}>
                    {craftData == ''
                      ? this.state.nontransform
                  ...
                  non-transformative use of the Music.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  Gross Sales or Gross Revenue generated or otherwise encumber such sales in any way
                  that would make it impossible for the royalty to be paid as contained herein.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  the end of each calendar quarter. For clarity, the Licensee may not merely sell
                  the Music in its original form.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  f. If Licensee registers the Derivative Work or Collective Work with a Performing
                  Rights Organization (PRO), Licensee shall register the work such that Licensor is
                  entitled to{' '}
                  <Text style={styles.inputs}>
                    {craftData == '' ? this.state.royalty : craftData.craft_items[0].royalty}%
                  </Text>{' '}
                  of the proceeds of the exploitation of the work via the PRO.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>6. DELIVERY OF MUSIC.</Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  a. The Licensor will provide a high-quality electronic version of the Music from
                  which the Licensee can use the Music solely for the purposes described in this
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  a. Ownership of Music. The Licensee acknowledges that the Licensor is the owner of
                  the Music and of all associated federal registrations and pending registrations,
                  and the Licensee shall do nothing inconsistent with that ownership. The Licensee
                  may not claim ownership rights to the Music, or any derivative, compilation,
                  sequel or series, or related work owned or used by the Licensor. Nothing in this
                  agreement gives the Licensee any interest in the Music other than the right to use
                  them in accordance with this agreement.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  b. Validity of Registrations. The Licensee admits the validity of all copyrights
                  for the Music and all associated registrations and acknowledges that all rights
                  that might be acquired to Music by the Licensee because of its use of the Music
                  shall inure to the sole benefit of the Licensor. The previous notwithstanding this
                  subsection does not entitle the Licensor to any of the revenues from the
                  Licensee’s permitted uses under this agreement, except for the fees described in
                  section 5 above.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  c. Limitation on Licensee’s Actions. The Licensee may not do anything inconsistent
                  with the Licensor’s ownership of the Music, claim adversely to the Licensor, or
                  ...
                  the Music, oppose any registration or re-registrations of the Music, or challenge
                  the validity of this agreement or the grants provided under it. The Licensee may
                  only not register the Music or any part thereof except in so far as they are
                  registered by Licensee as a Collective Works or Derivative Works created from the
                  Music which explicitly states that no claim is made to the Music except as the
                  Music is used in conjunction with the Collective Works or Derivative Works being
                  registered as Collective Works or Derivative Works. The Licensee may not re-sell
                  or exploit the Music in its original form, or in a form with merely deminimus
                  changes or deminimus additions. Licensee may only sell or exploit Collective Works
                  or Derivative Works created from the Music that are transformative in nature. Any
                  sale of the Music in its original form constitutes a material breach of this
                  Agreement and the Licensee shall be liable to Licensor for any resulting damages
                  incurred including and not limited to exemplary damages, as if the Music has been
                  registered as a copyright, regardless of whether the Music has actually been so
                  registered.
                </Text>
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  a. the Licensor is either the sole owner of all interest in the Music or otherwise
                  has such licenses and permissions as necessary to allow this transaction upon the
                  terms contained herein;
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  b. the Music does not infringe on the intellectual property rights of any third
                  party, is not in the public domain, and does not contain anything that is illegal
                  or legally defined as “obscene” by U.S. law;
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  c. the Licensor has not transferred, exclusively licensed, or encumbered the Music
                  or agreed to do so;
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  the Music purportedly licensed in section 1.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  of any gross proceeds generated by, arising from, or related to the Music.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  of all documentation (in any format) relating to the Music for the Licensee's own
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  i. execute any additional papers, including any separate licenses of the Music,
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  the Music, any Collective Work, or any Derivative Work that the Licensor may
                  reasonably require and will render any (nonmonetary) assistance reasonably
                  required by the Licensor in maintaining the Music or any registrations of the
                  Music.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>10. INDEMNIFICATION.</Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  If the Music infringes on any United States copyright of a third party not
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  the infringing Music, including as necessary any Collective Works or Derivative
                  Works, if requested by the Licensor.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  If the Licensee is enjoined from further use of any infringing Music or if the
                  Licensee stops using any of the Music (including as necessary any Collective Works
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  c. refund the amount paid under this agreement for the infringing Music to the
                  Licensee, on such terms as the parties may agree.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  d. reimburse Licensee for any costs or damages directly attributable to the Music
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  fully complied with the terms of this Agreement and the Music has not entered the
                  public domain. The Licensee shall only have the ability to create new Collective
                  Works or Derivative Works based on the Music during a 2-year period ending on the
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  iii. the Licensee attempts to transfer any of the rights granted to the Licensee
                  in connection with this agreement without obtaining the Licensor's prior written
                  consent;
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  iv. the Licensee uses the Music in a manner not expressly permitted by this
                  agreement;
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  v. no Collective Work, Derivative Work, or reproduction of Music is published
                  within one year of the effective date of this agreement, unless extended by
                  written permission of the Licensor;
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  vi. the copyright and acknowledgment notices are not printed as specified in
                  section 4; or
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  vii. Licensor earns no royalty on the Music, pursuant to this agreement for a
                  period of at least 6 months following the 1-year anniversary of this agreement.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  Licensor shall have an additional 10 days to cure, or this Agreement shall be
                  terminated.
                </Text>
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  d. Effect of Termination. All rights granted by this agreement, including the
                  Licensee's right to use the Music, shall end on termination of this agreement. On
                  termination of this agreement, the Licensee shall promptly discontinue all use of
                  Music, any Collective Work, or any Derivative Work, and refrain from further
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  ...
                  third-party, however the Licensee may continue to make payments to either the
                ...
                <Text style={[STYLES.textStyle, styles.maintext]}>
                  THE LICENSEE IS EXPRESSLY PROHIBITED FROM REGISTERING THE MUSIC AND/OR COLLECTIVE
                  WORK AND/OR DERIVATIVE WORK WITH ANY CONTENT IDENTIFICATION SYSTEM, SERVICE
                  PROVIDER, MUSIC DISTRIBUTOR, RECORD LABEL OR DIGITAL AGGREGATOR (for example,
                  TuneCore or CDBaby, and any other provider of user-generated content
                  identification services). The purpose of this restriction is to prevent you from
                  receiving a copyright infringement takedown notice from a third party who also
                  received a non-exclusive license to use the Music. If you do not adhere to this
                  policy, you are in violation of the terms of this License and your license to use
                  the Music may be revoked without notice or compensation to you.
                </Text>
...
LicenseMusicNon.propTypes = {
  onClose: PropTypes.func,
  status: PropTypes.bool,
  onCloseRequest: PropTypes.func,
};

LicenseMusicNon.defaultProps = {
  onClose: () => {},
  status: false,
  onCloseRequest: () => {},
};

export default LicenseMusicNon;
