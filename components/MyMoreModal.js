...
const MyMoreModal = ({ onClose, onShow, onShare }) => {
  return (
    <View style={styles.wrapper}>
      ...
      <View style={[styles.moreItem, { paddingVertical: 75 * METRICS.ratioY }]}>
...
MyMoreModal.propTypes = {
  onClose: PropTypes.func,
  onShow: PropTypes.func,
};

MyMoreModal.defaultProps = {
  onClose: () => {},
  onShow: () => {},
};

export default MyMoreModal;
