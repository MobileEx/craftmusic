...
export function withChatContext(OriginalComponent) {
  const ContextAwareComponent = getContextAwareComponent(ChatContext, OriginalComponent);
...
export function withChannelContext(OriginalComponent) {
  const ContextAwareComponent = getContextAwareComponent(ChannelContext, OriginalComponent);
  return ContextAwareComponent;
}
...
const getContextAwareComponent = function (context, originalComponent) {
  ...
  const ContextAwareComponent = function (props) {
    return <Context.Consumer>{(c) => <OriginalComponent {...c} {...props} />}</Context.Consumer>;
  };
