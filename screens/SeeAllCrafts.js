...
class SeeAllCrafts extends BaseScreen {
  navbarHidden = true;
  ...
  getData = () => {
    PlayingCraftService.getUserCraft(this.state.userId)
      .then((res) => {
        this.setState({
    ...
    return (
      <SafeAreaView style={styles.wrapper}>
        <ScreenHeader
          ...
          only_show_list={1}
          pageTitle={`${userProfile.username} Crafts`}
...
export default connect(mapStateToProps, mapDispatchToProps)(withNavigation(SeeAllCrafts));
